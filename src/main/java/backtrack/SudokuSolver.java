...
public class SudokuSolver {
  ...
  public static void main(String[] args) {
    ...
    int[][] board =
        {{0, 0, 0, 3, 0, 4, 8, 0, 0}, {0, 0, 9, 0, 2, 0, 0, 0, 0}, {7, 0, 8, 0, 0, 1, 6, 3, 0},
            {4, 0, 5, 0, 0, 0, 0, 0, 7}, {0, 9, 0, 0, 6, 0, 0, 5, 0}, {6, 0, 0, 0, 0, 0, 4, 0, 3},
            {0, 8, 6, 1, 0, 0, 3, 0, 9}, {0, 0, 0, 0, 5, 0, 1, 0, 0}, {0, 0, 7, 6, 0, 9, 0, 0, 0}};
